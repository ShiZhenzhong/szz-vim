...
exec "Snippet fun void ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet ifun int ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>return ".st."i".et."<CR>}<CR>".st.et
exec "Snippet lfun long ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet sfun static void ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet sifun static int ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
exec "Snippet slfun static long ".st.et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
